...
And the relative tests, RSpec is preferred, but Minitest is accepted.
Provide a zip including a git project.
Commits order, description and a comprehensible useful README are all part of the work.
